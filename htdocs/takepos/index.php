...
function incre() {
    ...
    $("#poslines").load("invoice.php?invoiceid="+$('#invoiceid').val()+"&action=updateqty&place="+place+"&idline="+selectedline+"&number="+editnumber2, function() {
            editnumber="";
            //$('#poslines').scrollTop($('#poslines')[0].scrollHeight);
...
function decr() {
    ...
    $("#poslines").load("invoice.php?click=1&invoiceid="+$('#invoiceid').val()+"&action=updateqty&place="+place+"&idline="+selectedline+"&number="+editnumber2, function() {
        editnumber="";
        //$('#poslines').scrollTop($('#poslines')[0].scrollHeight);
        $("#qty").html("<?php echo $langs->trans("Qty"); ?>");
    });
